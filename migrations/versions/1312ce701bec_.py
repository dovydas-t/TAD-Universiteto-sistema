...
Revision ID: 1312ce701bec
Revises: 
Create Date: 2025-05-26 01:33:52.174754
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('module_id', sa.Integer(), nullable=True),
    sa.Column('required_module_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['module_id'], ['module.id'], ),
    sa.ForeignKeyConstraint(['required_module_id'], ['module.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
